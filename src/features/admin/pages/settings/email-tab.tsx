  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex items-start gap-2 rounded-lg border border-[#111827]/15 bg-[#111827]/10 px-3.5 py-2.5 text-xs text-[#111827]">
        ...
        <span>
          The server is configured for Amazon SES SMTP through .env. Values saved
          here override those server defaults on each request. Leave a field blank
          to keep using the server configuration.
        </span>
      </div>
      ...
      <Card className="p-5">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <Field label="Mailer" hint="Use smtp for Amazon SES SMTP">
            <select
            ...
            >
              ...
              <option value="smtp">Amazon SES SMTP</option>
            ...
            <>
              <Field label="SMTP host">
                <input
                  ...
                  placeholder="email-smtp.eu-north-1.amazonaws.com"
                  className={inputCls}
                />
              </Field>
              ...
              <Field label="SES SMTP username">
                <input
                  ...
                  placeholder="Generated by Amazon SES SMTP settings"
                  className={inputCls}
                />
              </Field>
              <Field label="SES SMTP password" hint="write-only">
                <input
                  type="password"
