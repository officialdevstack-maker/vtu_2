    ...
    <div className="space-y-5">
      ...
      <Card className="p-5">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <Field label="Mailer" hint="Select an email provider">
            <select
            ...
            >
              ...
              <option value="smtp">SMTP (Gmail, SES, or other)</option>
              <option value="log">Log only (dev/testing)</option>
            </select>
          </Field>
          ...
          {form.mail_mailer === "smtp" && (
            <div className="sm:col-span-2 flex items-start gap-2 rounded-lg border border-blue-200 bg-blue-50 px-3.5 py-2.5 text-xs text-blue-800">
              <Info className="w-4 h-4 shrink-0 mt-0.5" />
              <div>
            ...
            <>
              <Field label="SMTP host">
                <input
                  ...
                  placeholder="e.g., smtp.gmail.com or email-smtp.eu-north-1.amazonaws.com"
                  className={inputCls}
                />
              </Field>
              ...
              <Field label="SMTP username">
                <input
                  ...
                  placeholder="e.g., your-email@gmail.com or SES SMTP username"
                  className={inputCls}
                />
              </Field>
              <Field label="SMTP password" hint="write-only">
                <input
                  type="password"
